...
export default function MealDropdown({
  ...
  return (
    <div
      ...
      className="relative bg-input ft-medium px-4 sm:px-5 md:px-6 py-2 rounded-4xl cursor-pointer flex justify-between items-center text-gray text-xs w-full md:w-50 mx-auto"
    >
