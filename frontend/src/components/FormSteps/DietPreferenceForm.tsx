...
const dietOptions: { title: string; description: string; value: TypeDiet }[] = [
  {
    title: "Basada en presupuesto",
    description:
      "La dieta se ajustará a un presupuesto semanal, incluyendo los alimentos que selecciones.",
    value: "Presupuesto",
  },
  {
    title: "Basada en alimentos disponibles",
    description:
...
export default function DietPreferenceForm({
  ...
  return (
    <div className="px-4 sm:px-6 md:px-10">
      ...
      <div className="flex flex-col gap-4 md:mt-8 md:mb-8">
        {dietOptions.map((option) => (
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-justify ft-light">
              {option.description}
            </p>
          </button>
        ))}
