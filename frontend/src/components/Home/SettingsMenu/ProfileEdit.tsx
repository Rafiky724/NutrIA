          ...
          <>
            ...
            <div className="md:w-xl flex flex-col justify-between">
              ...
              <button
                ...
                disabled={loading}
                className="w-full md:w-xs mx-auto ft-medium bg-yellow text-brown p-3 rounded-full mt-4 hover:scale-105 transition disabled:opacity-50 cursor-pointer text-xs"
              >
                {loading
                  ? "Guardando..."
                  : isEditing
